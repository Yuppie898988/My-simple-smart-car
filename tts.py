...
def ttsc_example(command):
    ...
    project_id = '0a3a3358c78026cf2f7bc005f3765082'     # 同region一一对应，参考https://support.huaweicloud.com/api-sis/sis_03_0008.html
    text =  command           # 待合成文本，不超过500字
    path = 'welcome.wav'           # 保存路径，如D:/test.wav。 可在设置中选择不保存本地
